...
set CLASSPATH=%CLASSPATH%;%LIB%\esper-instrumented-5.4.0.jar
goto core_cp_done
:use_uninstrumented
...
set CLASSPATH=%CLASSPATH%;%LIB%\esper-eeutilagent-5.4.0.jar
...
rem
rem set CLASSPATH=%CLASSPATH%;%LIB%\esper-dataflow-groovy-5.4.0.jar
...
rem
rem set CLASSPATH=%CLASSPATH%;%LIB%\esper-example-geo-5.4.0.jar;..\..\example_geo\target\esper-example-geo-5.4.0.jar
rem set CLASSPATH=%CLASSPATH%;%LIB%\esper-example-onlineshop-5.4.0.jar;..\..\example_onlineshop\target\esper-example-onlineshop-5.4.0.jar
rem set CLASSPATH=%CLASSPATH%;%LIB%\esper-example-optiontrade-5.4.0.jar;..\..\example_optiontrade\target\esper-example-optiontrade-5.4.0.jar

rem Esper HA dependencies
rem
rem set CLASSPATH=%CLASSPATH%;%ESPERHA_DEP_LIB%\esperha-core-5.4.0.jar
rem set CLASSPATH=%CLASSPATH%;%ESPERHA_DEP_LIB%\esperha-ehafile-5.4.0.jar
rem set CLASSPATH=%CLASSPATH%;%ESPERHA_DEP_LIB%\esperha-xsdboe-5.4.0.jar
