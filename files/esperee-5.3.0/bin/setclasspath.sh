...
then
  CLASSPATH=$CLASSPATH:$LIB/esper-instrumented-5.3.0.jar
else
...
CLASSPATH=$CLASSPATH:$LIB/esper-eeutilagent-5.3.0.jar
...
#
# CLASSPATH=$CLASSPATH:$LIB/esper-dataflow-groovy-5.3.0.jar
...
#
# CLASSPATH=$CLASSPATH:$LIB/esper-example-geo-5.3.0.jar
# CLASSPATH=$CLASSPATH:$LIB/esper-example-onlineshop-5.3.0.jar
# CLASSPATH=$CLASSPATH:$LIB/esper-example-optiontrade-5.3.0.jar

#  Esper HA dependencies
#
# CLASSPATH=$CLASSPATH:$ESPERHA_DEP_LIB/esperha-core-5.3.0.jar
# CLASSPATH=$CLASSPATH:$ESPERHA_DEP_LIB/esperha-ehafile-5.3.0.jar
# CLASSPATH=$CLASSPATH:$ESPERHA_DEP_LIB/esperha-xsdboe-5.3.0.jar
