...
public class Simulator {
    ...
    public Simulator(String engineURI)
    {
        ...
        if (!engine.getEPAdministrator().getDeploymentAdmin().isDeployed("com.espertech.esper.server.example.geoapp")) {
            String eplFile = "geoapp.epl";
            try {
        ...
        ThreadFactory threadFactory = new SimulatorThreadFactory(engineURI, "GeoExample");
