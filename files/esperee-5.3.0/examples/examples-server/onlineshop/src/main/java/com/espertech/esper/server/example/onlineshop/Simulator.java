...
public class Simulator {
    ...
    public Simulator(String engineURI)
    {
        ...
        if (!engine.getEPAdministrator().getDeploymentAdmin().isDeployed("com.espertech.esper.server.example.onlineshop")) {
            String eplFile = "onlineshop.epl";
            try {
        ...
        ThreadFactory threadFactory = new SimulatorThreadFactory(engineURI, "OnlineShopExample");
        ...
        {
            log.debug("Starting simulator thread pool, " + NUM_SEND_THREADS + " threads in pool");
        }
