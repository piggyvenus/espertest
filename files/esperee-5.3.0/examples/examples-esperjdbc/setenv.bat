...
set CLASSPATH=%CLASSPATH%;%EE_HOME%\lib\esper-5.3.0.jar
set CLASSPATH=%CLASSPATH%;%EE_HOME%\lib\esper-jdbc-server-5.3.0.jar
set CLASSPATH=%CLASSPATH%;%EE_HOME%\lib\esper-jdbc-driver-5.3.0.jar
